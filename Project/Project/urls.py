...
urlpatterns = patterns('',
    ...
    url(r'^member_center/(?P<user_id>\d+)/$', 'pets_adopt.views.center.main', name='center_main'),
    url(r'^member_center/my_pet/(?P<user_id>\d+)/$', 'pets_adopt.views.center.my_pet', name='my_pet'),
    url(r'^member_center/sending_pet/(?P<user_id>\d+)/$', 'pets_adopt.views.center.sending_pet', name='sending_pet'),
    url(r'^member_center/receiving_pet/(?P<user_id>\d+)/$', 'pets_adopt.views.center.receiving_pet', name='receiving_pet'),
